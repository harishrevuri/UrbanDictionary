package com.example.urbandictionary.activity
...
import com.example.urbandictionary.util.DataSourceProvider
import com.example.urbandictionary.adapter.DictionaryAdapter
...
class MainActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinnerAdapter = ArrayAdapter(this, R.layout.spinner_view,
            SORT_TYPE
        )
